...
Корпоративный LLM Gateway — OpenAI-совместимый прокси с журналом аудита, санитайзингом входных данных и подключаемыми адаптерами. Разворачивается внутри корпоративного контура, подключает любую LLM.
